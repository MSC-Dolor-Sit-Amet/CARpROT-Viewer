...
import { Card, CardBody, Code, FormControl, FormLabel, Heading, HStack, LinkOverlay, Stack, Switch } from '@chakra-ui/react';
import DrawerComponent from '../components/Drawer';

function Home({ drawerProps, inputProps, resultProteins }) {
